...
- افزودن معیار مالی ماهانه شامل نرخ دستی دلار، تاریخ نرخ، مانده اختیاری کل پس‌انداز و منبع/یادداشت.
- نمایش درآمد دلاری، پس‌انداز دلاری ماه، ارزش دلاری کل پس‌انداز و تغییر ماهانه و سالانه آن‌ها.
- محاسبه رشد واقعی درآمد پس از اثر تورم شخصی سبد کالاها.
- یکسان‌سازی گروه‌بندی شاخص قیمت و دخل‌وخرج روی ماه‌های هجری شمسی، از جمله عبور از مرز ماه میلادی.
- افزودن جدول `financialSnapshots` با migration نسخه 4 Dexie بدون حذف داده‌های قبلی.
- ارتقای Backup به نسخه 3، پشتیبانی از نسخه‌های 1 و 2، Merge بر اساس ماه و CSV مستقل معیارهای مالی.
- گسترش داده نمونه، مستندات و تست‌های regression برای تبدیل دلاری، درآمد واقعی و سازگاری Backup قدیمی.

## 1.4.0

- افزودن حسابداری شخصی ساده برای ثبت، ویرایش و حذف درآمدها و هزینه‌های غیرکالایی.
- افزودن صفحه «دخل‌وخرج» با گزارش ماه‌های شمسی، مانده، سبد دسته‌های هزینه، نمودار ۱۲ ماهه و دفتر یکپارچه خرید/تراکنش.
- محاسبه تغییر مخارج واقعی نسبت به ماه قبل و ماه مشابه سال قبل.
- درنظرگرفتن خودکار خرید کالا به‌عنوان هزینه برای جلوگیری از ثبت تکراری.
- تغییر فرم خرید: کاربر مقدار واقعی و مبلغ واقعی پرداخت‌شده را وارد می‌کند و قیمت مؤثر واحد خودکار محاسبه می‌شود.
- حفظ اختیاری مبلغ قبل از تخفیف و استخراج خودکار مقدار تخفیف.
- افزودن جدول `transactions` با migration نسخه 3 Dexie بدون حذف داده‌های قبلی.
- ارتقای Backup به نسخه 2 همراه با سازگاری ورود Backup نسخه 1 و افزودن Transactionها به Replace/Merge و فایل رمزدار.
- افزودن CSV مستقل دخل‌وخرج و قفل واحد پول پس از نخستین رکورد مالی از هر نوع.
- گسترش داده نمونه و تست‌های regression برای cashflow، مقایسه درصدی، ماه شمسی، Merge و Backup قدیمی.
